...
setwd("C:/Users/Ltischer/Documents/Studium/A Master/Geostatistics/R-Skripte")
...
# !!! Width kann unter Umständen die Daten verfälschen (zieht einzelen Messpunkte falls übereinander auseinander)
